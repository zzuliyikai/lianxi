...
public class Electrocardiogram extends View {
    ...
    // 横向的线，即纵向大格子的数量，每个大格子里面包含5个小格子
    int horizontalBigGirdNum = 6;
    // 纵向的线，即横向大格子的数量。
    ...
    public void startDraw() {
        runnable = new Runnable() {
            ...
            public void run() {
                addData();
                mHandler.postDelayed(runnable, 200);        // 100 ms 增加一个数据
            }
        };
    ...
    private void drawGird(Canvas canvas) {
        ...
        for (int i = 0; i <= horizontalBigGirdNum * 5; i++) {
            ...
            canvas.drawText("" + i, 0, i * widthOfSmallGird, paint);
